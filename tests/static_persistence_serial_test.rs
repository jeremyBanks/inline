...
fn test_static_persistence_same_value() {
    ...
    fn get_value() -> code_cell::CodeCell<u32> {
        code_cell(100u32)  // Always the same source location
    }
...
fn test_static_persistence_value_mutation() {
    ...
    fn get_counter() -> code_cell::CodeCell<u32> {
        code_cell(100u32)  // Always same source location
    }
...
fn test_static_persistence_different_locations() {
    ...
    let val1 = code_cell(10u32);
    let val2 = code_cell(20u32);
    let val3 = code_cell(30u32);
...
fn test_static_persistence_different_types() {
    ...
    let val_u32 = code_cell(42u32);
    let val_i32 = code_cell(42i32);
...
fn test_static_persistence_across_function_calls() {
    ...
    fn increment_counter() -> u32 {
        let mut counter = code_cell(1u32);
        let current = *counter;
